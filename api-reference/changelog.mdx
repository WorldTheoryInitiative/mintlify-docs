...
- **Changelog Page**: Added comprehensive changelog documentation to track all API updates

### Improvements

- **Pagination Fixed**: Standardized pagination across all endpoints with consistent cursor-based navigation
- **Kalshi Market Filtering**: Automatically filter out MVE (Minimum Viable Event) markets from Kalshi results
...
- Requests exceeding limit=25 will be capped at 25
